...
try:
    s = ConstBitStream(filename='/home/mihai/ArhivaDateLema/memorie1.dat')
except IOError:
...
####################################################
##TODO: sa fac cu args, zipuri si directorul complet
# a = [bs.hex for bs in s.split('0xf6f5')]
# print a
...
while 1: 
    ...
    icol_values = GetValuesFromIcol(icol) # intoarce un dictionar 
